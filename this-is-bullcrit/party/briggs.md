...
|----|-----------|-------|-------------|
| 16 (Unarmored Defense) | +3 | 30 ft. | +2 |

**Saving Throws:** STR* +5 | DEX +3 | CON* +5 | INT +1 | WIS +2 | CHA +2  
*proficient

**Skills (proficient):** Athletics +5, Insight +4, Intimidation +4, Perception +4, Performance +4, Survival +4
